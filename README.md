...
<p align="center">
  ...
  ·
  <a href="docs/release-notes/0.8.4.md"><strong>0.8.4 Release Notes</strong></a>
</p>
...
| Bounded adaptive and parallel specialist chains | `ai-fabric-execution` with Java- or manifest-defined exact-version chains | [Bounded Multi-Specialist Chains](docs/Framework-Dev-Guides/application-patterns/BOUNDED_MULTI_SPECIALIST_CHAINS.md) |
...
```xml
<properties>
  <ai-fabric.version>0.8.4</ai-fabric.version>
</properties>
...
- [Release notes](docs/release-notes/0.8.4.md): current behavior and migration considerations.
...
The current release is **`0.8.4`**. AI Fabric remains on a `0.x` release line, so review release
notes and migration guidance before upgrading:

- [AI Fabric 0.8.4 release notes](docs/release-notes/0.8.4.md)
