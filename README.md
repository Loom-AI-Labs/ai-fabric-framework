...
<p align="center">
  ...
  ·
  <a href="docs/release-notes/0.8.1.md"><strong>0.8.1 Release Notes</strong></a>
</p>
...
```xml
<properties>
  <ai-fabric.version>0.8.1</ai-fabric.version>
</properties>
...
- [Release notes](docs/release-notes/0.8.1.md): current behavior and migration considerations.
...
The current release is **`0.8.1`**. AI Fabric remains on a `0.x` release line, so review release
notes and migration guidance before upgrading:

- [AI Fabric 0.8.1 release notes](docs/release-notes/0.8.1.md)
