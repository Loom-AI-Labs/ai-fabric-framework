...
| **ai-fabric-account-resolver** / **sub-management-hub-simple** | AI-powered account resolution and subscription management | rag, provider-spring-ai, vector-lucene | An OpenAI key for live LLM behavior |
