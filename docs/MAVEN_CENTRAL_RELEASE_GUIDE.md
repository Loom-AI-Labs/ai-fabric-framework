...
```bash
git tag -a ai-fabric-framework-v0.8.4 -m "AI Fabric Framework 0.8.4"
git push origin ai-fabric-framework-v0.8.4
```
...
curl -s -o /dev/null -w '%{http_code}\n' \
  https://repo1.maven.org/maven2/io/github/loom-ai-labs/ai-fabric-bom/0.8.4/ai-fabric-bom-0.8.4.pom
```
