...
```bash
git tag -a ai-fabric-framework-v0.6.1 -m "AI Fabric Framework 0.6.1"
git push origin ai-fabric-framework-v0.6.1
```
...
curl -s -o /dev/null -w '%{http_code}\n' \
  https://repo1.maven.org/maven2/io/github/loom-ai-labs/ai-fabric-bom/0.6.1/ai-fabric-bom-0.6.1.pom
```
