...
3. Search with a paraphrased account-access question before indexing.
4. Observe no evidence.
5. Index the five records.
6. Repeat the same query.
7. Inspect the expected article ID, score, content, metadata, and readiness count.
