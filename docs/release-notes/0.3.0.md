...
- **Released:** 2026-06-27
- **Version:** `0.3.0`
- **Release tag:** `ai-fabric-framework-v0.3.0`
- **Release commit:** `93d1cf4`
- **Maven version:** `0.3.0`
...
Provider registry APIs mark Cohere chat/embeddings and Anthropic embeddings as disabled modeled
entries so capability discovery does not advertise them as executable.
...
- provider-native Spring AI tool callbacks execute unconfirmed actions only; guarded actions return
  `CONFIRMATION_REQUIRED` and must continue through AI Fabric's confirmation flow
...
Supported embedding choices in this release:
