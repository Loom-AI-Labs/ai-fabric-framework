...
@Slf4j
@Component
@ConditionalOnClass(name = "ai.fabric.relationship.service.EntityRelationshipMapper")
@ConditionalOnBean(type = "ai.fabric.relationship.service.EntityRelationshipMapper")
...
public class BehaviorRelationshipRegistration {
    ...
    public void registerRelationships() {
        ...
        try {
            Class<?> mapperClass = Class.forName("ai.fabric.relationship.service.EntityRelationshipMapper");
