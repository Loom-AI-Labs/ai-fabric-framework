package ai.fabric.relationship.action;
...
public class RelationshipQueryActionHandler {
    ...
    public ActionResult handleError(Exception e, String userId) {
        ...
        if (e instanceof ai.fabric.relationship.exception.RelationshipQueryException rqe) {
            rqe.getContext().ifPresent(ctx -> {
                ...
                ai.fabric.relationship.dto.RelationshipQueryPlan plan = ai.fabric.relationship.dto.RelationshipQueryPlan.builder()
                    ...
                    .queryStrategy(ai.fabric.relationship.dto.QueryStrategy.RELATIONSHIP)
