...
class AccountResolverOrchestrationConfigurationTest {
    ...
    void resolverPromptOverlayBindsAndFallsBackToDefaultBundle(String configFile) throws IOException {
        ...
        assertThat(compoundSystem.template())
            ...
            .contains("whether the account is ready, eligible")
            .contains("able to place an order")
            .contains("vectorSpace=\"account-resolution-policy\"")
            .contains("Do not classify this readiness or diagnostic request as a top-level ACTION")
