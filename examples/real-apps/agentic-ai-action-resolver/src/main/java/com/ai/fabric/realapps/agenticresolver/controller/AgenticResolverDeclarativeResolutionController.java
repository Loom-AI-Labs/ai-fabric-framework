...
import com.ai.fabric.realapps.agenticresolver.agentic.AccountDeclarativeResolutionService;
...
@RestController
@RequestMapping("/api/agentic-resolver/declarative-resolutions")
@ConditionalOnProperty(
    name = "ai.execution.specialist-chains.enabled",
    havingValue = "true"
)
public class AgenticResolverDeclarativeResolutionController {

    private final AccountDeclarativeResolutionService service;

    public AgenticResolverDeclarativeResolutionController(
        AccountDeclarativeResolutionService service
    ) {
