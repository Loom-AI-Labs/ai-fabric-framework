...
public class IncidentPlanConfiguration {
    ...
    @Bean
    ExecutionPlanDefinition<IncidentPlanRequest, IncidentInvestigationAssessment>
        incidentSequentialPlanV2() {
        return definitionV2(
            IncidentPlans.SEQUENTIAL_V2,
            List.of(serviceBranchV2(), changeBranchV2())
        );
    }

    @Bean
    ExecutionPlanDefinition<IncidentPlanRequest, IncidentInvestigationAssessment>
        incidentParallelPlanV2() {
        return definitionV2(
    ...
    private ExecutionPlanDefinition<IncidentPlanRequest, IncidentInvestigationAssessment>
    definitionV2(
        ai.fabric.execution.plan.ExecutionPlanId id,
        List<? extends PlanStage> stages
    ) {
