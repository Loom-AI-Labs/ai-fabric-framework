...
@EnableConfigurationProperties(IncidentCorsConfiguration.CorsProperties.class)
class IncidentCorsConfiguration implements WebMvcConfigurer {

    private final CorsProperties properties;

    IncidentCorsConfiguration(CorsProperties properties) {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        if (properties.allowedOrigins().isEmpty()
            && properties.allowedOriginPatterns().isEmpty()) {
            return;
        }
