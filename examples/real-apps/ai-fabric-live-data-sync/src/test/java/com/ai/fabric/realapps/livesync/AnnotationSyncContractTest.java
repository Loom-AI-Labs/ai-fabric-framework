...
class AnnotationSyncContractTest {
    ...
    void applicationAndAllEntityTypesExposeTheAnnotationDrivenSyncContract() {
        ...
        for (Class<?> entityClass : List.of(SyncProduct.class, SyncPolicy.class, SyncGuide.class)) {
            ...
            assertThat(fields).anyMatch(field -> field.isAnnotationPresent(AIIdentity.class));
    ...
    private void assertLifecycle(
        ...
        assertProcess(serviceClass, createMethod, AIProcessOperation.CREATE);
        assertProcess(serviceClass, updateMethod, AIProcessOperation.UPDATE);
        assertProcess(serviceClass, deleteMethod, AIProcessOperation.DELETE);
    }
    ...
    private void assertProcess(
        ...
        assertThat(process.operation()).isEqualTo(operation);
    }
}
