...
public interface AppBehaviorEventRepository extends JpaRepository<AppBehaviorEvent, Long> {
    ...
    List<AppBehaviorEvent> findByUserIdAndEventTimestampAfterOrderByEventTimestampAsc(
        String userId,
    ...
    Optional<AppBehaviorEvent> findByUserIdAndExternalEventId(String userId, String externalEventId);
